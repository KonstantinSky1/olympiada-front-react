    ...
    <li className="all-news__list-item">
      <div className="all-news__list-itemBlock">
        <div className="all-news__list-item-textBlock">
          ...
          <h4 className="all-news__list-item-title"><Link to={`/news/${post.id}`} className="all-news__list-item-title-link">{post.title}</Link></h4>
          ...
          <p className="all-news__list-item-text">{post.body}</p>
