  ...
  return (
    <nav className="navigation">
      <ul className="navigation__list">
        ...
        <li className="navigation__list-item"><NavLink className="navigation__list-item-NavLink" to="/courses" style={({isActive}) => isActive ? {fontWeight: 700} : undefined}>Курсы</NavLink></li>
        <li className="navigation__list-item"><NavLink className="navigation__list-item-NavLink" to="/tutors" style={({isActive}) => isActive ? {fontWeight: 700} : undefined}>Репетиторы</NavLink></li>
        <li className="navigation__list-item"><NavLink className="navigation__list-item-NavLink" to="/onlinestudy" style={({isActive}) => isActive ? {fontWeight: 700} : undefined}>Онлайн-обучение</NavLink></li>
        ...
        <li className="navigation__list-item"><NavLink className="navigation__list-item-NavLink" to="/tournaments" style={({isActive}) => isActive ? {fontWeight: 700} : undefined}>Турниры</NavLink></li>
