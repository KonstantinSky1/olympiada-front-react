        ...
        <ul className="navigation__list">
          <li className="navigation__list-item">
            ...
            <ul>
              ...
              <li className="navigation__list-item"><NavLink className="navigation__list-item-NavLink" to="/hkjkhkblablabla" style={({isActive}) => isActive ? {fontWeight: 700} : undefined} onClick={() => {setMenuActive(false); document.body.classList.remove('_lock');}}>Расписание 2022</NavLink></li>
            </ul>
          </li>
          ...
          <li className="navigation__list-item"><NavLink className="navigation__list-item-NavLink" to="/bvnmvnxuiblablabla" style={({isActive}) => isActive ? {fontWeight: 700} : undefined} onClick={() => {setMenuActive(false); document.body.classList.remove('_lock');}}>Дневник</NavLink></li>
